...
"""
Step 9: Model Testing Script - v1
...
MODEL_PATH = "/Users/jvarghese/Documents/TrafficSignProject/output/yolo_output_v1/runs/train/traffic_signs_yolo12n_v1/weights/best.pt"
TEST_DIR = "/Users/jvarghese/Documents/TrafficSignProject/output/yolo_output_v1/runs/test_imagesize_1024/traffic_signs_yolo12n_v1"
    ...
    try:
        ...
        if os.path.exists(test_images_dir):
            ...
            if len(test_images) > 0:
                ...
                fig.suptitle('Sample Test Predictions - YOLO12n v1 Model', fontsize=16, fontweight='bold')
...
if __name__ == "__main__":
    print("🔍 YOLO MODEL TEST PREDICTIONS - v1")
    print("=" * 60)
