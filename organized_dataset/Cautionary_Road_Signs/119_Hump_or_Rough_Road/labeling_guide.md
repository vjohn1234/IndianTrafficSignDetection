# Labeling Guide: Hump_or_Rough_Road

## Class Information
- **Sequential ID:** 119 (folder number)
- **Original ID:** 122 (dataset class ID)
- **Class Name:** Hump_or_Rough_Road
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/119_Hump_or_Rough_Road/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/119_Hump_or_Rough_Road/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Hump_or_Rough_Road`
