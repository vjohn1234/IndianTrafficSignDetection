# Labeling Guide: Steep_Ascent

## Class Information
- **Sequential ID:** 107 (folder number)
- **Original ID:** 107 (dataset class ID)
- **Class Name:** Steep_Ascent
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/107_Steep_Ascent/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/107_Steep_Ascent/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Steep_Ascent`
