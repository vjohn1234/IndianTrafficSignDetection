# Labeling Guide: Unguarded_Level_Crossing

## Class Information
- **Sequential ID:** 130 (folder number)
- **Original ID:** 133 (dataset class ID)
- **Class Name:** Unguarded_Level_Crossing
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/130_Unguarded_Level_Crossing/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/130_Unguarded_Level_Crossing/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Unguarded_Level_Crossing`
