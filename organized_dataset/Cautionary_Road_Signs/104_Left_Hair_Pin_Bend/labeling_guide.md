# Labeling Guide: Left_Hair_Pin_Bend

## Class Information
- **Sequential ID:** 104 (folder number)
- **Original ID:** 104 (dataset class ID)
- **Class Name:** Left_Hair_Pin_Bend
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/104_Left_Hair_Pin_Bend/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/104_Left_Hair_Pin_Bend/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Left_Hair_Pin_Bend`
