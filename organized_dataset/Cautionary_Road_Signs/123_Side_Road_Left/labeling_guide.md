# Labeling Guide: Side_Road_Left

## Class Information
- **Sequential ID:** 123 (folder number)
- **Original ID:** 126 (dataset class ID)
- **Class Name:** Side_Road_Left
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/123_Side_Road_Left/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/123_Side_Road_Left/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Side_Road_Left`
