# Labeling Guide: Gap_in_Median

## Class Information
- **Sequential ID:** 121 (folder number)
- **Original ID:** 124 (dataset class ID)
- **Class Name:** Gap_in_Median
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/121_Gap_in_Median/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/121_Gap_in_Median/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Gap_in_Median`
