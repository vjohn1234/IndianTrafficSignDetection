# Labeling Guide: Narrow_Bridge

## Class Information
- **Sequential ID:** 110 (folder number)
- **Original ID:** 111 (dataset class ID)
- **Class Name:** Narrow_Bridge
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/110_Narrow_Bridge/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/110_Narrow_Bridge/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Narrow_Bridge`
