# Labeling Guide: Cattle

## Class Information
- **Sequential ID:** 116 (folder number)
- **Original ID:** 118 (dataset class ID)
- **Class Name:** Cattle
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/116_Cattle/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/116_Cattle/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Cattle`
