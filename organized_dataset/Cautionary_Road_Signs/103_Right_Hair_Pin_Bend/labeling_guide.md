# Labeling Guide: Right_Hair_Pin_Bend

## Class Information
- **Sequential ID:** 103 (folder number)
- **Original ID:** 103 (dataset class ID)
- **Class Name:** Right_Hair_Pin_Bend
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/103_Right_Hair_Pin_Bend/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/103_Right_Hair_Pin_Bend/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Right_Hair_Pin_Bend`
