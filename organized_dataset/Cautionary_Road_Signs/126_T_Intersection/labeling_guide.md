# Labeling Guide: T_Intersection

## Class Information
- **Sequential ID:** 126 (folder number)
- **Original ID:** 129 (dataset class ID)
- **Class Name:** T_Intersection
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/126_T_Intersection/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/126_T_Intersection/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `T_Intersection`
