# Labeling Guide: Falling_Rocks

## Class Information
- **Sequential ID:** 117 (folder number)
- **Original ID:** 120 (dataset class ID)
- **Class Name:** Falling_Rocks
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/117_Falling_Rocks/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/117_Falling_Rocks/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Falling_Rocks`
