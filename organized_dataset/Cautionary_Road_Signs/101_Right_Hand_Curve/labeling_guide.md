# Labeling Guide: Right_Hand_Curve

## Class Information
- **Sequential ID:** 101 (folder number)
- **Original ID:** 101 (dataset class ID)
- **Class Name:** Right_Hand_Curve
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/101_Right_Hand_Curve/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/101_Right_Hand_Curve/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Right_Hand_Curve`
