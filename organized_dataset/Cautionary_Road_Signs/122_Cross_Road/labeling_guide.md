# Labeling Guide: Cross_Road

## Class Information
- **Sequential ID:** 122 (folder number)
- **Original ID:** 125 (dataset class ID)
- **Class Name:** Cross_Road
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/122_Cross_Road/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/122_Cross_Road/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Cross_Road`
