# Labeling Guide: Y_Intersection

## Class Information
- **Sequential ID:** 125 (folder number)
- **Original ID:** 128 (dataset class ID)
- **Class Name:** Y_Intersection
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/125_Y_Intersection/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/125_Y_Intersection/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Y_Intersection`
