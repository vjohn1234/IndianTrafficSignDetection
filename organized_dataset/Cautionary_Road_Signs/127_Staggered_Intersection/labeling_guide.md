# Labeling Guide: Staggered_Intersection

## Class Information
- **Sequential ID:** 127 (folder number)
- **Original ID:** 130 (dataset class ID)
- **Class Name:** Staggered_Intersection
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/127_Staggered_Intersection/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/127_Staggered_Intersection/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Staggered_Intersection`
