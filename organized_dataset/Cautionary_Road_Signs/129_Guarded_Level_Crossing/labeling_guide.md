# Labeling Guide: Guarded_Level_Crossing

## Class Information
- **Sequential ID:** 129 (folder number)
- **Original ID:** 132 (dataset class ID)
- **Class Name:** Guarded_Level_Crossing
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/129_Guarded_Level_Crossing/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/129_Guarded_Level_Crossing/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Guarded_Level_Crossing`
