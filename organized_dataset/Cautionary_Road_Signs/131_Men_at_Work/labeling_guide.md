# Labeling Guide: Men_at_Work

## Class Information
- **Sequential ID:** 131 (folder number)
- **Original ID:** 135 (dataset class ID)
- **Class Name:** Men_at_Work
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/131_Men_at_Work/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/131_Men_at_Work/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Men_at_Work`
