# Labeling Guide: Cycle_Crossing

## Class Information
- **Sequential ID:** 113 (folder number)
- **Original ID:** 114 (dataset class ID)
- **Class Name:** Cycle_Crossing
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/113_Cycle_Crossing/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/113_Cycle_Crossing/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Cycle_Crossing`
