# Labeling Guide: U_Turn_Ahead

## Class Information
- **Sequential ID:** 132 (folder number)
- **Original ID:** 136 (dataset class ID)
- **Class Name:** U_Turn_Ahead
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/132_U_Turn_Ahead/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/132_U_Turn_Ahead/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `U_Turn_Ahead`
