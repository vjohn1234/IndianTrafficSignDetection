# Labeling Guide: Left_Reverse_Bend

## Class Information
- **Sequential ID:** 106 (folder number)
- **Original ID:** 106 (dataset class ID)
- **Class Name:** Left_Reverse_Bend
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/106_Left_Reverse_Bend/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Cautionary_Road_Signs/106_Left_Reverse_Bend/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Left_Reverse_Bend`
