...
## Class Information
- **Sequential ID:** 001 (folder number)
- **Original ID:** 001 (dataset class ID)
- **Class Name:** Stop
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/001_Stop/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/001_Stop/annotations`
