# Labeling Guide: Compulsory_Turn_Left

## Class Information
- **Sequential ID:** 015 (folder number)
- **Original ID:** 026 (dataset class ID)
- **Class Name:** Compulsory_Turn_Left
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/015_Compulsory_Turn_Left/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/015_Compulsory_Turn_Left/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Compulsory_Turn_Left`
