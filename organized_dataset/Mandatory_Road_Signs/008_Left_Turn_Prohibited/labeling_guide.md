# Labeling Guide: Left_Turn_Prohibited

## Class Information
- **Sequential ID:** 008 (folder number)
- **Original ID:** 014 (dataset class ID)
- **Class Name:** Left_Turn_Prohibited
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/008_Left_Turn_Prohibited/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/008_Left_Turn_Prohibited/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Left_Turn_Prohibited`
