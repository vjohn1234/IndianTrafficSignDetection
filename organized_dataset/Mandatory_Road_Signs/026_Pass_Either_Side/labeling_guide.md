# Labeling Guide: Pass_Either_Side

## Class Information
- **Sequential ID:** 026 (folder number)
- **Original ID:** 040 (dataset class ID)
- **Class Name:** Pass_Either_Side
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/026_Pass_Either_Side/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/026_Pass_Either_Side/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Pass_Either_Side`
