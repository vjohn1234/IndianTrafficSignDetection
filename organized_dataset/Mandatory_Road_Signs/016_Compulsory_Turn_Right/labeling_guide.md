# Labeling Guide: Compulsory_Turn_Right

## Class Information
- **Sequential ID:** 016 (folder number)
- **Original ID:** 027 (dataset class ID)
- **Class Name:** Compulsory_Turn_Right
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/016_Compulsory_Turn_Right/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/016_Compulsory_Turn_Right/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Compulsory_Turn_Right`
