# Labeling Guide: Speed_Limit_60

## Class Information
- **Sequential ID:** 027 (folder number)
- **Original ID:** 041 (dataset class ID)
- **Class Name:** Speed_Limit_60
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/027_Speed_Limit_60/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/027_Speed_Limit_60/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Speed_Limit_60`
