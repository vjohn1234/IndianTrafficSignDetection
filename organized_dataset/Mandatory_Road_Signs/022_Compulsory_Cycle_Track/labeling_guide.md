# Labeling Guide: Compulsory_Cycle_Track

## Class Information
- **Sequential ID:** 022 (folder number)
- **Original ID:** 034 (dataset class ID)
- **Class Name:** Compulsory_Cycle_Track
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/022_Compulsory_Cycle_Track/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/022_Compulsory_Cycle_Track/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Compulsory_Cycle_Track`
