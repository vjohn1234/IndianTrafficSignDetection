# Labeling Guide: Speed_Limit_40

## Class Information
- **Sequential ID:** 025 (folder number)
- **Original ID:** 039 (dataset class ID)
- **Class Name:** Speed_Limit_40
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/025_Speed_Limit_40/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/025_Speed_Limit_40/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Speed_Limit_40`
