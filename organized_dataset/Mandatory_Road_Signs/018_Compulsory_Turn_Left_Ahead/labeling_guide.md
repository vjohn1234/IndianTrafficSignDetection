# Labeling Guide: Compulsory_Turn_Left_Ahead

## Class Information
- **Sequential ID:** 018 (folder number)
- **Original ID:** 030 (dataset class ID)
- **Class Name:** Compulsory_Turn_Left_Ahead
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/018_Compulsory_Turn_Left_Ahead/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/018_Compulsory_Turn_Left_Ahead/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Compulsory_Turn_Left_Ahead`
