# Labeling Guide: Overtaking_Prohibited

## Class Information
- **Sequential ID:** 010 (folder number)
- **Original ID:** 016 (dataset class ID)
- **Class Name:** Overtaking_Prohibited
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/010_Overtaking_Prohibited/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/010_Overtaking_Prohibited/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Overtaking_Prohibited`
