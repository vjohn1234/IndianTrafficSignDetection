# Labeling Guide: No_Entry

## Class Information
- **Sequential ID:** 003 (folder number)
- **Original ID:** 003 (dataset class ID)
- **Class Name:** No_Entry
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/003_No_Entry/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/003_No_Entry/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `No_Entry`
