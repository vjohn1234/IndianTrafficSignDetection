# Labeling Guide: No_Parking

## Class Information
- **Sequential ID:** 013 (folder number)
- **Original ID:** 024 (dataset class ID)
- **Class Name:** No_Parking
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/013_No_Parking/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/013_No_Parking/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `No_Parking`
