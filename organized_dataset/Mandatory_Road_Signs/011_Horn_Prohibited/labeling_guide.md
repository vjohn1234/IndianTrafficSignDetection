# Labeling Guide: Horn_Prohibited

## Class Information
- **Sequential ID:** 011 (folder number)
- **Original ID:** 017 (dataset class ID)
- **Class Name:** Horn_Prohibited
...
1. **Open labelImg** and configure:
   - Open Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/011_Horn_Prohibited/images`
   - Change Save Dir: `/Users/jvarghese/Documents/TrafficSignProject/organized_dataset/Mandatory_Road_Signs/011_Horn_Prohibited/annotations`
   - Enable Auto Save mode

2. **For each image:**
   - Draw bounding box around the entire traffic sign
   - Use class name: `Horn_Prohibited`
